...
void MainLayer::onInitialization() {
	...
	image_coffee = new River::SubTexture("assets/coffee.jpg", 100, 100, 760.0/2.0, 506.0/2.0);
	image_llama = new River::SubTexture("assets/A.png");
	...
	santaEntity->addComponent<River::ECS::Sprite>()->x = 400;
	...
	santaEntity = domain.createEntity();
	santaEntity->addComponent<River::ECS::Sprite>()->x = -0;
	anim = santaEntity->addComponent<River::ECS::AnimatedSprite>();
	anim->animation = santaAnimation;
